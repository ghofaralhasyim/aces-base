  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="flex justify-center pt-8 sm:pt-0">
        <img src="~assets/img/aceslabs.png" alt="" />
        <h1 style="font-size: 3rem; color: #2d2d2d">ACES Labs</h1>
      </div>
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to ACES Base Code
        </h2>
        <p class="mt-3 text-gray-600">
          It's based on Nuxt JS. We recommend you take a look at the
          <a
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/ghofaralhasyim/aces-base" target="_blank"
          ><svg
